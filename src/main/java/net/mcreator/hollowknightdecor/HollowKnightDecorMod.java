package net.mcreator.hollowknightdecor;
...
public class HollowKnightDecorMod {
	public static final Logger LOGGER = LogManager.getLogger(HollowKnightDecorMod.class);
	public static final String MODID = "hollow_knight_decor";

	public HollowKnightDecorMod() {
